...
function major() {
    var incident = {
        // Incident name
        name: 'Major xteve connectivity issues',
        // Incident description (supports markdown)
        message: 'XTeVe is currently having major connectivity issues on Firepower Cloud.',
    ...
    cachet.reportIncident(incident)
        .then(function (response) {
            // Log API response
            console.log('XTeVe Major Outage Reported at ' + response.data.created_at);
        }).catch(function (err) {
