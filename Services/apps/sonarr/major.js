...
function major() {
    var incident = {
        // Incident name
        name: 'Major sonarr connectivity issues',
        // Incident description (supports markdown)
        message: 'Sonarr is currently having major connectivity issues on Firepower Cloud.',
    ...
    cachet.reportIncident(incident)
        .then(function (response) {
            // Log API response
            console.log('Sonarr Major Outage Reported at ' + response.data.created_at);
        }).catch(function (err) {
